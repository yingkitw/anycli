...
#[cfg(test)]
mod snapshot_tests {
    use crate::{LocalVectorStore, LocalDocumentIndexer, LocalRAGEngine};
    use cuc_core::{VectorStore, VectorDocument, SearchConfig, Document, RAGQuery, DocumentIndexer, RAGEngine};
    use serde_json::json;
    use std::sync::Arc;
